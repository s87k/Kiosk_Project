...
public class UnsignedLongDocument extends PlainDocument{
	...
	private int minVal;
	/**
	 * 최대값 (범위: minVal ~ 9,223,372,036,854,775,807) 
	 */
	private long maxVal;
...
//		System.out.println(digit + " " + minVal + " " + maxVal);
	...
	public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
		...
		try {
			int numCurrentOne = Integer.parseInt(str);
			...
			case 1:
				...
				break;
			default: 
				long numEntire = Long.parseLong(getText(0, getLength()).concat(str));

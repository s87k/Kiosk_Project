...
//		ImageIcon iLogin = new ImageIcon(getClass().getClassLoader().getResource("kiosk_prj/image/login.png"));
		ImageIcon logo = new ImageIcon(getClass().getClassLoader().getResource("kiosk_prj/image/login_logo.png"));
